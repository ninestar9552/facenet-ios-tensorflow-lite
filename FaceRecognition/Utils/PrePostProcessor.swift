...
//    static let outputRow = 25200 // YOLOv5 모델 input size 640 * 640 기준 output Row 값 25200
    static let outputRow = 1 // facenet_512 모델 input size 160 * 160 기준 output Row 값 1
    static let outputColumn = 512 // 클래스 수 + 5 (left, top, right, bottom, score) 값
...
//        print("outputs count: \(outputs.count)")  // 배열 크기 확인
